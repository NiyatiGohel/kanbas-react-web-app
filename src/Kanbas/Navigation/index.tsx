...
import { FaHistory, FaUsersCog, FaVideo, FaRegQuestionCircle, FaFileExport } from 'react-icons/fa';
import "./style.css";
...
export default function KanbasNavigation() {
    return (
      ...
      <a id="wd-neu-link" href="https://www.northeastern.edu/" className="list-group-item bg-black border-0">
        ...
        <LiaCogSolid className="fs-1 text-danger" /><br />
          Labs</a>
          <a id="wd-history-link" href="#/Labs" className="list-group-item text-white bg-black text-center border-0">
        <FaHistory className="fs-1 text-danger" /><br />
          History</a>
          <a id="wd-commons-link" href="#/Labs" className="list-group-item text-white bg-black text-center border-0">
        <FaUsersCog className="fs-1 text-danger" /><br />
          Commons</a>
          <a id="wd-help-link" href="#/Labs" className="list-group-item text-white bg-black text-center border-0">
        <FaRegQuestionCircle className="fs-1 text-danger" /><br />
          Help</a>
        </div>
