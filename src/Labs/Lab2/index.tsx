...
<div id="wd-css-responsive-tables">
  <h2 className="heading">Responsive tables</h2>
...
<div id="wd-css-hyperlink-list">
  <h3 className="heading">Favorite books</h3>
...
<div id="wd-css-styling-forms">
  ...
  <h3 className="heading">Dropdowns</h3>
...
<div id="wd-css-styling-switches">
  <h3 className="heading">Switches</h3>
...
<div id="wd-css-styling-addons">
  <h3 className="heading">Addons</h3>
...
<div id="wd-css-responsive-forms-1">
  <h3 className="heading">Responsive forms</h3>
